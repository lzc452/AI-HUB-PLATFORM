...
export const applicationDraftSchema = applicationDraftShape
  .extend({ deliveries: z.array(deliveryDraftItemSchema).min(1, "交付配置不能为空") })
...
export const applicationDraftDefaults: ApplicationDraftFormValues = {
  ...
  faq: [],
  audience: [{ audienceType: "all", departmentId: [], employeeId: [], includeChildren: false }],
  risk: {
