...
async function upsertIdentity(
  ...
  if (data.departments.length > 0) {
    await db
      ...
      .values(data.departments as never)
      .onConflict((oc) =>
        oc.column("department_id").doUpdateSet((eb) => ({
  ...
  for (const emp of data.employees) {
    await db
      ...
      .values(emp as never)
      .onConflict((oc) =>
        oc.column("employee_id").doUpdateSet((eb) => ({
  ...
  if (data.departmentMemberships.length > 0) {
    await db
      ...
      .values(data.departmentMemberships as never)
      .onConflict((oc) =>
        oc.columns(["employee_id", "department_id"]).doUpdateSet((eb) => ({
  ...
  if (data.employeeRoles.length > 0) {
    await db
      ...
      .values(data.employeeRoles as never)
  ...
  if (data.identityAuditEvents.length > 0) {
    await db
      ...
      .values(data.identityAuditEvents as never)
      .onConflict((oc) => oc.column("audit_event_id").doNothing())
      .execute();
  }
}
...
async function upsertApplication(
  ...
  if (data.applications.length > 0) {
    await db
      ...
      .values(data.applications as never)
      .onConflict((oc) =>
        oc.column("application_id").doUpdateSet((eb) => ({
          name: eb.ref("excluded.name"),
          summary: eb.ref("excluded.summary"),
          status: eb.ref("excluded.status"),
          current_version_id: eb.ref("excluded.current_version_id"),
          updated_at: eb.ref("excluded.updated_at"),
        })),
      )
      .execute();
  ...
  if (data.applicationVersions.length > 0) {
    await db
      ...
      .values(data.applicationVersions as never)
      .onConflict((oc) =>
        oc.column("application_version_id").doUpdateSet((eb) => ({
  ...
  if (data.applicationDeliveries.length > 0) {
    await db
      ...
      .values(data.applicationDeliveries as never)
      .onConflict((oc) =>
        oc.column("delivery_id").doUpdateSet((eb) => ({
          channel: eb.ref("excluded.channel"),
          entry_url: eb.ref("excluded.entry_url"),
  ...
  if (data.applicationReviews.length > 0) {
    await db
      ...
      .values(data.applicationReviews as never)
      .onConflict((oc) => oc.column("review_id").doNothing())
      .execute();
  }
  if (data.applicationReviewQueue.length > 0) {
    await db
      .insertInto("application_review_queue")
      .values(data.applicationReviewQueue as never)
      .onConflict((oc) => oc.column("review_queue_id").doNothing())
      .execute();
  }
  if (data.applicationAuditEvents.length > 0) {
    await db
      .insertInto("application_audit_events")
      .values(data.applicationAuditEvents as never)
      .onConflict((oc) => oc.column("audit_event_id").doNothing())
      .execute();
  }
}
...
async function upsertCatalog(
  ...
  if (data.categories.length > 0) {
    await db
      ...
      .values(data.categories as never)
      .onConflict((oc) =>
        oc.column("category_id").doUpdateSet((eb) => ({
          name: eb.ref("excluded.name"),
  ...
  if (data.tags.length > 0) {
    await db
      ...
      .values(data.tags as never)
      .onConflict((oc) =>
        oc.column("tag_id").doUpdateSet((eb) => ({
          name: eb.ref("excluded.name"),
        })),
      )
      .execute();
  ...
  if (data.metadata.length > 0) {
    await db
      ...
      .values(data.metadata as never)
      .onConflict((oc) =>
        oc.column("application_id").doUpdateSet((eb) => ({
          category_id: eb.ref("excluded.category_id"),
          health_status: eb.ref("excluded.health_status"),
          replacement_application_id: eb.ref(
            "excluded.replacement_application_id",
          ),
        })),
      )
      .execute();
  ...
  if (data.audiences.length > 0) {
    await db
      ...
      .values(data.audiences as never)
      .onConflict((oc) => oc.column("audience_id").doNothing())
      .execute();
  }
  if (data.tagLinks.length > 0) {
    await db
      .insertInto("application_tag_links")
      .values(data.tagLinks as never)
      .onConflict((oc) => oc.columns(["application_id", "tag_id"]).doNothing())
      .execute();
  }
  if (data.labels.length > 0) {
    await db
      .insertInto("application_catalog_labels")
      .values(data.labels as never)
      .onConflict((oc) => oc.columns(["application_id", "label"]).doNothing())
      .execute();
  }
  if (data.deliveryActions.length > 0) {
    await db
      .insertInto("catalog_delivery_actions")
      .values(data.deliveryActions as never)
      .onConflict((oc) => oc.column("action_id").doNothing())
      .execute();
  }
}
...
async function upsertAppInteraction(
  ...
  if (data.applicationLikes.length > 0) {
    await db
      ...
      .values(data.applicationLikes as never)
      .onConflict((oc) =>
  ...
  if (data.applicationRatings.length > 0) {
    await db
      ...
      .values(data.applicationRatings as never)
      .onConflict((oc) =>
        oc.column("rating_id").doUpdateSet((eb) => ({
  ...
  if (data.applicationComments.length > 0) {
    await db
      ...
      .values(data.applicationComments as never)
      .onConflict((oc) => oc.column("comment_id").doNothing())
      .execute();
  }
  if (data.applicationReports.length > 0) {
    await db
      .insertInto("application_reports")
      .values(data.applicationReports as never)
...
async function upsertDemand(
  ...
  if (data.demands.length > 0) {
    for (const d of data.demands) {
      await db
        ...
        .values(d as never)
        .onConflict((oc) =>
          oc.column("demand_id").doUpdateSet((eb) => ({
            title: eb.ref("excluded.title"),
            problem_statement: eb.ref("excluded.problem_statement"),
            desired_outcome: eb.ref("excluded.desired_outcome"),
            status: eb.ref("excluded.status"),
            priority_score: eb.ref("excluded.priority_score"),
            version: eb.ref("excluded.version"),
            updated_at: eb.ref("excluded.updated_at"),
          })),
        )
  ...
  if (data.demandCollaborators.length > 0) {
    await db
      ...
      .values(data.demandCollaborators as never)
  ...
  if (data.demandAuditEvents.length > 0) {
    await db
      ...
      .values(data.demandAuditEvents as never)
      .onConflict((oc) => oc.column("audit_event_id").doNothing())
      .execute();
  }
}
...
async function upsertDemandInteraction(
  ...
  if (data.demandComments.length > 0) {
    await db
      ...
      .values(data.demandComments as never)
      .onConflict((oc) => oc.column("comment_id").doNothing())
      .execute();
  }
  if (data.demandLikes.length > 0) {
    await db
      ...
      .values(data.demandLikes as never)
      .onConflict((oc) => oc.columns(["demand_id", "employee_id"]).doNothing())
      .execute();
  }
  if (data.demandCommentLikes.length > 0) {
    await db
      ...
      .values(data.demandCommentLikes as never)
  ...
  if (data.demandReports.length > 0) {
    await db
      ...
      .values(data.demandReports as never)
      .onConflict((oc) => oc.column("report_id").doNothing())
      .execute();
  }
  if (data.demandProgressUpdates.length > 0) {
    await db
      ...
      .values(data.demandProgressUpdates as never)
      .onConflict((oc) => oc.column("progress_id").doNothing())
      .execute();
  }
  if (data.demandPilots.length > 0) {
    await db
      .insertInto("ai_demand_pilots")
      .values(data.demandPilots as never)
      .onConflict((oc) => oc.column("pilot_id").doNothing())
      .execute();
  }
  if (data.demandApplications.length > 0) {
    await db
      .insertInto("ai_demand_applications")
      .values(data.demandApplications as never)
      .onConflict((oc) =>
        oc.columns(["demand_id", "application_id"]).doNothing(),
      )
      .execute();
  }
}
...
async function upsertNotification(
  ...
  if (data.notifications.length > 0) {
    await db
      ...
      .values(data.notifications as never)
      .onConflict((oc) =>
...
async function upsertAnalytics(
  ...
  if (data.behaviorEvents.length > 0) {
    await db
      ...
      .values(data.behaviorEvents as never)
      .onConflict((oc) =>
        oc.column("event_id").doUpdateSet((eb) => ({
          event_name: eb.ref("excluded.event_name"),
  ...
  if (data.exportJobs.length > 0) {
    await db
      ...
      .values(data.exportJobs as never)
      .onConflict((oc) =>
        oc.column("export_id").doUpdateSet((eb) => ({
          status: eb.ref("excluded.status"),
  ...
  if (data.auditEvents.length > 0) {
    await db
      ...
      .values(data.auditEvents as never)
      .onConflict((oc) => oc.column("audit_event_id").doNothing())
      .execute();
  }
  if (data.outboxEvents.length > 0) {
    await db
      ...
      .values(data.outboxEvents as never)
...
export async function seedDemoDataset(
  ...
  await db.transaction().execute(async (trx) => {
    ...
    if (domains.includes("identity"))
      await upsertIdentity(trx, fixtures.identity);
    if (domains.includes("application"))
      await upsertApplication(trx, fixtures.application);
    ...
    if (domains.includes("notification"))
      await upsertNotification(trx, fixtures.notification);
    if (domains.includes("analytics"))
      await upsertAnalytics(trx, fixtures.analytics);
  });

  const counts: Record<DemoDatasetDomain, number> = {
    identity:
      fixtures.identity.departments.length + fixtures.identity.employees.length,
    application:
      fixtures.application.applications.length +
      fixtures.application.applicationVersions.length +
      fixtures.application.applicationDeliveries.length,
    catalog:
      fixtures.catalog.categories.length +
      fixtures.catalog.tags.length +
      fixtures.catalog.metadata.length,
    demand:
      fixtures.demand.demands.length +
      fixtures.demand.demandCollaborators.length,
    notification: fixtures.notification.notifications.length,
    analytics:
      fixtures.analytics.behaviorEvents.length +
      fixtures.analytics.dailyAggregates.length,
  };

  return {
    anchorDate: options.anchorDate.toISOString(),
    counts: Object.freeze(counts) as Readonly<
      Record<DemoDatasetDomain, number>
    >,
